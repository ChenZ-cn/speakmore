...
This repository is the open-source export of the macOS MVP. It contains the Swift app, tests, local build scripts, a lightweight server-proxy skeleton, and public documentation. It does not include private API keys, local user settings, raw audio, packaged apps, or release artifacts.
